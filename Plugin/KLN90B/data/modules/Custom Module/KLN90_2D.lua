...
components = {
  ...
  clickable {
    ...
    onMouseWheel = function(x, y, w, h, r, t, clicks)
      if clicks > 0 then
        commandOnce(sasl.findCommand("custom/KLN90/Increase_Brightness"))
      elseif clicks < 0 then
        commandOnce(sasl.findCommand("custom/KLN90/Decrease_Brightness"))
      end
  ...
  clickable {
    ...
    onMouseWheel = function(x, y, w, h, r, t, clicks)
      if clicks > 0 then
        commandOnce(sasl.findCommand("custom/KLN90/Turn_Right_Small_Knob_Clockwise"))
      elseif clicks < 0 then
        commandOnce(sasl.findCommand("custom/KLN90/Turn_Right_Small_Knob_Counterclockwise"))
      end
  ...
  clickable {
    ...
    onMouseWheel = function(x, y, w, h, r, t, clicks)
      if clicks > 0 then
        commandOnce(sasl.findCommand("custom/KLN90/Turn_Left_Small_Knob_Clockwise"))
      elseif clicks < 0 then
        commandOnce(sasl.findCommand("custom/KLN90/Turn_Left_Small_Knob_Counterclockwise"))
      end
